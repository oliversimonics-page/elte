...
public class ElectionStructureTest {
    ...
    public static void init() {
        CheckThat.theClass("java6.election.Election")
    ...
    public void methodAddVote() {
        it.hasMethod("addVote", withParams("java6.election.candidate.Candidate"))
            .thatIs(FULLY_IMPLEMENTED, INSTANCE_LEVEL, VISIBLE_TO_ALL)
            .thatReturnsNothing();
    }
    ...
    public void methodAddVotes() {
        it.hasMethod("addVotes", withParams("java6.election.candidate.Candidate", "int"))
            .thatIs(FULLY_IMPLEMENTED, INSTANCE_LEVEL, VISIBLE_TO_ALL)
            .thatReturnsNothing();
    }
    ...
    public void methodGetWinner() {
        it.hasMethodWithNoParams("getWinner")
            .thatIs(FULLY_IMPLEMENTED, INSTANCE_LEVEL, VISIBLE_TO_ALL)
            .thatReturns("java6.election.candidate.Candidate");
    }
