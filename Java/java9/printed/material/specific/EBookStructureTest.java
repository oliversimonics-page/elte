package java9.printed.material.specific;
...
public class EBookStructureTest {
    ...
    public static void init() {
        CheckThat.theClass("java9.printed.material.specific.EBook")
    ...
    public void constructor() {
        it.hasConstructor(withArgs("book: java9.printed.material.Book", "pdfSize: int", "isUnitPrefix: boolean", "unit: String"))
