...
public class FanStructureTest {
    ...
    public static void init() {
        CheckThat.theClass("java5.music.fan.Fan")
    ...
    public void fieldFavourite() {
        it.hasField("favourite: java5.music.recording.Artist")
            .thatIs(INSTANCE_LEVEL, NOT_MODIFIABLE, VISIBLE_TO_NONE)
            .thatHas(GETTER)
            .thatHasNo(SETTER);
    }
    ...
    public void constructor() {
        it.hasConstructor(withParams("String", "java5.music.recording.Artist"))
